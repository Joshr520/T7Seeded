detour zm_theater<scripts\zm\zm_theater.gsc>::initcharacterstartindex()
{
	level.characterstartindex = SRandomInt("character", 4);
}

detour zm_theater<scripts\zm\zm_theater.gsc>::assign_lowest_unused_character_index()
{
	charindexarray = [];
	charindexarray[0] = 0;
	charindexarray[1] = 1;
...
detour zm_theater<scripts\zm\zm_theater.gsc>::function_c027d01d()
{
	temp_array = [];
