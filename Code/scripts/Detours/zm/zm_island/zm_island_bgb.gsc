detour zm_island_bgb<scripts\zm\zm_island_bgb.gsc>::function_fa778ca4()
{
	...
	if (str_player_zone == "zone_bunker_prison" && !level flag::get("flag_outro_cutscene_done")) {
		...
		s_respawn_point = SArrayRandom(var_14452bdb, "zm_island_bgb_abh");
	}
...
detour zm_island_bgb<scripts\zm\zm_island_bgb.gsc>::function_2d0e5eb6()
{
	...
	str_powerup = SArrayRandom(var_62e2eaf2, "zm_island_bgb_feelin_lucky");
	return str_powerup;
}